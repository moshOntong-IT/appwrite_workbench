...
class CreateFunctionDialog extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return const _Main().scope(overrides: [
      ...
      functionsControllerProvider.overrideWith(FunctionsController.new),
...
class _Main extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final functionState = ref.watch(functionsControllerProvider);

    ref.listen(functionsControllerProvider, (prev, next) {
